...
\vspace{0.5 cm}
\uncover<2->{\textcolor{darkblue}{Largely switched to C++, where the data structures are free (but serialization isn't).}}

\vspace{0.5 cm}
\uncover<3->{\textcolor{darkblue}{The CHEP conferences cover that timespan, can we see the transition?}}
\end{minipage}
\end{center}
\end{frame}
