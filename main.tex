...
\LARGE
\begin{center}
\textcolor{darkblue}{\only<1>{Physicists invented the first digital computer}\only<2>{\xcancel{Physicists invented the first digital computer}}\only<3>{Physicists invented \textcolor{purple}{one of} the first digital computer\textcolor{purple}{s}}}
\end{center}
\end{frame}
...
\begin{frame}{But this one: ENIAC, the first {\it widely-known} computer (1945)}
\vspace{0.35 cm}
...
\vspace{0.1 cm}
\uncover<3->{It was funded, project led by Army General Gladeon Barnes, and computed trajectories 1000$\times$ faster than mechanical computers.}
\end{frame}
