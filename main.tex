...
\begin{frame}{Case in point: HEP-Fortran was not Fortran}
\scriptsize
\vspace{0.25 cm}
\begin{center}
...
\begin{columns}
\column{1.1\linewidth}
\uncover<2->{\includegraphics[width=0.24\linewidth]{PLOTS/root-website-1.png}}\hfill\uncover<3->{\includegraphics[width=0.24\linewidth]{PLOTS/root-website-2.png}}\hfill\uncover<4->{\includegraphics[width=0.24\linewidth]{PLOTS/root-website-3.png}}\hfill\uncover<5->{\includegraphics[width=0.24\linewidth]{PLOTS/root-website-4.png}}
\end{columns}
...
\vspace{0.5 cm}
\uncover<2->{\textcolor{darkblue}{The CHEP conferences cover that timespan, can we see the transition?}}
\end{minipage}
\end{center}
\vspace{1 cm}
\end{frame}

\begin{frame}{\only<1>{Regex matches of all CHEP titles and abstracts, 1985--2021}\only<2>{What about programming {\it paradigms}?}\only<3>{What about specific {\it packages}?}\only<4>{The denominator (total number of talks) explains the weird dips.}}
\vspace{0.15 cm}
\begin{columns}
\column{1.1\linewidth}
\only<1>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-language.pdf}}\only<2>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-paradigm.pdf}}\only<3>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-package.pdf}}\only<4>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-denominator.pdf}}
\end{columns}
\end{frame}
...
\vspace{-6.25 cm}
\uncover<2->{\mbox{ }\hfill\fcolorbox{black}{white}{\begin{minipage}{0.65\linewidth}\vspace{0.75 cm}\begin{center}\begin{minipage}{0.75\linewidth}\Large They do coincide in time. \\ Neither is clearly before the other. \end{minipage}\end{center}\vspace{0.5 cm}\end{minipage}}\hfill\mbox{ }}
\vspace{6.25 cm}
\end{frame}
...
\only<1>{\includegraphics[width=\linewidth]{PLOTS/hllhc-python-timeline-0.pdf}}\only<2>{\includegraphics[width=\linewidth]{PLOTS/hllhc-python-timeline-1.pdf}}\only<3>{\includegraphics[width=\linewidth]{PLOTS/hllhc-python-timeline-2.pdf}}\only<4>{\includegraphics[width=\linewidth]{PLOTS/hllhc-python-timeline-3.pdf}}\only<5>{\includegraphics[width=\linewidth]{PLOTS/hllhc-python-timeline-4.pdf}}\only<6>{\includegraphics[width=\linewidth]{PLOTS/hllhc-python-timeline-5.pdf}}
\end{columns}
\end{frame}
...
\column{0.55\linewidth}
\uncover<5->{Meanwhile, the following things happened in mainstream computing:}

\vspace{0.25 cm}
\begin{itemize}\setlength{\itemsep}{0.25 cm}
\item<6-> High-level programming languages got more expressive.

\item<7-> A whole field of science grew up around ``seeing things in a picture.''

\item<8-> The internet happened.

\item<9-> Free, open-source, centrally distributed software became the dominant model.
...
\vspace{0.25 cm}
\fbox{\includegraphics[width=0.5\linewidth]{PLOTS/dremel.png}}
...
\begin{frame}{There's still resistance to mainstream practices}
\vspace{0.15 cm}
\begin{columns}
\column{1.1\linewidth}
\only<1>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-package-2.pdf}}\only<2>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-package-3.pdf}}
\end{columns}
\end{frame}

\begin{frame}{But data analysts are more free now to select what they need}
\vspace{0.15 cm}
\begin{columns}
\column{1.1\linewidth}
\only<1>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-language-2.pdf}}\only<2>{\includegraphics[width=\linewidth]{PLOTS/chep-papers-language-3.pdf}}
\end{columns}
\end{frame}
...
\large
\vspace{0.5 cm}
Since we were there at the beginning, physicists are the ultimate ``early adopters'' of computer technology.

\vspace{0.5 cm}
\uncover<2->{Computers weren't ready for us, so we developed brilliant custom solutions to get the work done.}

\vspace{0.5 cm}
\uncover<3->{Those HEP-specific choices became entrenched, preventing us from adopting mainstream solutions where possible and engaging computer scientists elsewhere.}

\vspace{0.5 cm}
\uncover<4->{Today, data scientists are solving HEP-like problems on web-scale datasets. Some of their solutions can work or be adapted to work for us.}

\vspace{0.5 cm}
\uncover<5->{Physicists have been quietly adopting those tools and practices, melting the domain boundaries that separate our fields.}
\end{frame}
